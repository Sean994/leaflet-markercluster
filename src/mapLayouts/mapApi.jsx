...
const jawgMap = {
    ...
    sunnyUrl : 'https://{s}.tile.jawg.io/jawg-sunny/{z}/{x}/{y}{r}.png',
...
const waymarkedTrails = {
    ...
    attribution: '<a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors | Map style: &copy; <a href="https://waymarkedtrails.org">waymarkedtrails.org</a> (<a href="https://creativecommons.org/licenses/by-sa/3.0/">CC-BY-SA</a>'
}
...
export { jawgMap , defaultMap , oneMap , hereApi, waymarkedTrails }
